...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        if (typeof options.dateLimitDaysSort === 'boolean')
            this.dateLimitDaysSort = options.dateLimitDaysSort;
        ...
        if (typeof options.dateLimitDays === 'function')
            this.dateLimitDays = options.dateLimitDays;
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            if (this.endDate == null && this.dateLimitDaysSort) {                 
                var addDays = this.dateLimitDays(this.startDate);
                if(addDays){
                    var maxLimit = this.startDate.clone().add({'days':addDays}).endOf('day');
                    maxDate = maxLimit;
                }
            }
            
//            if (this.isInvalidTime(time.minute(0).second(0)))
//                    disabled = true;
