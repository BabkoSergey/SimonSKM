...
@section('htmlheader_title') {{ __('Page') }} @endsection
...
<div class="row">
    <div class="col-md-12">
        ...
        {!! Form::open(array('method'=>'POST', 'route' => 'pages.store', 'class' => 'form-horizontal')) !!}
            <!-- Horizontal Form -->
            <div class="box box-info">            
                <div class="box-header with-border">
                    <h3 class="box-title">{{__('Add New Page')}}</h3>
                </div><!-- /.box-header -->
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! Form::text('url', null, array('placeholder' => __('Friendly URL'),'class' => 'form-control js-friendly-url', 'required' )) !!}                            
                        </div>
