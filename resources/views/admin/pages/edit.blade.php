            ...
            <div class="box box-info">            
                ...
                <div class="box-body">
                    <div class="form-group">
                        <label for="logo" class="col-sm-2 control-label">{{__('Page logo')}}</label>
                            ...
                            <div class="input-group js-related_target" id="js-related_target-logo">
                                <div class="input-group-btn">
                                    <button type="button" class="btn btn-default img-logo js-img-logo">
                                        <img src="{{$page->logo ?? asset('/img/blank_flag.gif')}}">
                                    </button>
                                </div>
                                <!-- /btn-group -->
                                {!! Form::text('logo', $page->logo ?? null, array('placeholder' => __('Select/Upload file or set absolute Url path'),'class' => 'form-control js-img-set-val')) !!}
                    ...
                    <div class="form-group">
                        <label for="url" class="col-sm-2 control-label">{{__('Friendly URL')}} *</label>

                        <div class="col-sm-10">
                            {!! Form::text('url', $page->url, array('placeholder' => __('Friendly URL'),'class' => 'form-control js-friendly-url', 'required', (Auth::user()->hasPermissionTo('add pages') ? '' : 'readonly') )) !!}                            
                        </div>
                            ...
                            @foreach($locales['avalible'] as $locale)
                                ...
                                <div class="tab-pane {{ $locale == $locales['def'] ? 'active' : '' }}" id="tab_{{$locale}}">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::text($locale.'[name]', $page->contents()->where('locale', $locale)->first()->name ?? null, array('placeholder' => __('Name'),'class' => 'form-control js-friendly-name', ($locale == $locales['def'] ? 'required' : '') )) !!}                            
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::textarea($locale.'[content]', $page->contents()->where('locale', $locale)->first()->content ?? null, array('placeholder' => __('Content'),'class' => 'form-control', 'rows' => '5', 'id' => 'cke-content-'.$locale )) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::text($locale.'[title]', $page->contents()->where('locale', $locale)->first()->title ?? null, array('placeholder' => __('Title'),'class' => 'form-control' )) !!}                            
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::textarea($locale.'[description]', $page->contents()->where('locale', $locale)->first()->description ?? null, array('placeholder' => __('Description'),'class' => 'form-control', 'rows'=> '3')) !!}                            
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::textarea($locale.'[meta]', $page->contents()->where('locale', $locale)->first()->meta ?? null, array('placeholder' => __('Meta'),'class' => 'form-control', 'rows'=> '3')) !!}                            
                                        </div>
                                    </div>
                ...
                <div class="box-footer">
                    <a class="btn btn-default" role="button" href="{{ route('pages.index') }}">{{ __('Cancel') }}</a>
...
@push('scripts') 
    ...
    <script>
        $(function () {  
          ...
          $(document).on('change','.js-friendly-url',function (){                
                $('.js-friendly-url').val(slugify($(this).val()));      
            });
            
            $(document).on('keyup','.js-friendly-url',function (){                
                $('.js-friendly-url').val(slugify($(this).val()));      
            });
