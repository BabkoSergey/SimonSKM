...
@section('htmlheader_title') {{ __('Category') }} @endsection
...
<div class="row">
    <div class="col-md-12">
        ...
        {!! Form::open(array('method'=>'POST', 'route' => 'art_categorys.store', 'class' => 'form-horizontal')) !!}
            <!-- Horizontal Form -->
            <div class="box box-info">            
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">                            
                            {!! Form::select('parent', $categorys, [], array('class' => 'form-control', 'placeholder' => '...' )) !!}                            
                        </div>                        
                    </div>
