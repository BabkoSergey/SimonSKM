            ...
            <div class="box box-info">            
                ...
                <div class="box-body">
                    <div class="form-group">
                        <label for="logo" class="col-sm-2 control-label">{{__('Service logo')}}</label>
                            ...
                            <div class="input-group js-related_target" id="js-related_target-logo">
                                <div class="input-group-btn">
                                    <button type="button" class="btn btn-default img-logo js-img-logo">
                                        <img src="{{$service->logo ?? asset('/img/blank_flag.gif')}}">
                                    </button>
                                </div>
                                <!-- /btn-group -->
                                {!! Form::text('logo', $service->logo ?? null, array('placeholder' => __('Select/Upload file or set absolute Url path'),'class' => 'form-control js-img-set-val')) !!}
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-info btn-flat" data-toggle="modal" data-target="#modal-img-set" data-path_type="service"><i class="fa fa-upload"></i></button>
                                </span>                                
                            </div>     
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! Form::select('status', array(0=> __('Disabled'), 1=> __('Active') ), $service->status ?? 0, array('class' => 'form-control','single', 'required')) !!}                            
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <label for="order" class="col-sm-2 control-label">{{__('Service order')}}</label>
                        
                        <div class="col-sm-10">
                            {!! Form::number('order', $service->order ?? 0, array('placeholder' => __('Service order'),'class' => 'form-control', 'min'=>0)) !!}                            
                        </div>
                    </div>
                            ...
                            @foreach($locales['avalible'] as $locale)
                                ...
                                <div class="tab-pane {{ $locale == $locales['def'] ? 'active' : '' }}" id="tab_{{$locale}}">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::text($locale.'[name]', $service->contents()->where('locale', $locale)->first()->name ?? null, array('placeholder' => __('Name'),'class' => 'form-control js-friendly-name', ($locale == $locales['def'] ? 'required' : '') )) !!}                            
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::text($locale.'[url]', $service->contents()->where('locale', $locale)->first()->url ?? null, array('placeholder' => __('Friendly URL'),'class' => 'form-control js-friendly-url', ($locale == $locales['def'] ? 'required' : '') )) !!}                            
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::textarea($locale.'[content]', $service->contents()->where('locale', $locale)->first()->content ?? null, array('placeholder' => __('Content'),'class' => 'form-control', 'rows' => '5', 'id' => 'cke-content-'.$locale )) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::text($locale.'[title]', $service->contents()->where('locale', $locale)->first()->title ?? null, array('placeholder' => __('Title'),'class' => 'form-control' )) !!}                            
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::textarea($locale.'[description]', $service->contents()->where('locale', $locale)->first()->description ?? null, array('placeholder' => __('Description'),'class' => 'form-control', 'rows'=> '3')) !!}                            
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::textarea($locale.'[meta]', $service->contents()->where('locale', $locale)->first()->meta ?? null, array('placeholder' => __('Meta'),'class' => 'form-control', 'rows'=> '3')) !!}                            
                                        </div>
                                    </div>
                ...
                <div class="box-footer">
                    <a class="btn btn-default" role="button" href="{{ route('services.index') }}">{{ __('Cancel') }}</a>
