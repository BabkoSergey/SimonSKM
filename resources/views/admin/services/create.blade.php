...
@section('htmlheader_title') {{ __('Service') }} @endsection
...
<div class="row">
    <div class="col-md-12">
        ...
        {!! Form::open(array('method'=>'POST', 'route' => 'services.store', 'class' => 'form-horizontal')) !!}
            <!-- Horizontal Form -->
            <div class="box box-info">            
                <div class="box-header with-border">
                    <h3 class="box-title">{{__('Add New Service')}}</h3>
                </div><!-- /.box-header -->
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! Form::number('order', 0, array('placeholder' => __('Service order'),'class' => 'form-control', 'min'=>0)) !!}                            
                        </div>
                    </div>
